...
This is assessment project for React Fundamentals. The README provides a quick way of how to run the project as well as the project structure.
...
└── src
    ...
    ├── BooksGrid.js # A react component to display collection of books and shelf selector
    ├── BooksList.js # This file holds 'BooksShelf' components to display different shelves
    ├── BooksSearch.js # This file contains book search field as well as 'BooksGrid' component
    ├── BooksShelf.js # A react component to display book shelf and 'BooksGrid' component
